...
// Q) 정수로 나오는 이유?
// A) JS에서는 정수와 실수를 구별하지 않고 모두 'Number'타입으로 처리한다.
...
// Q3. 다음 코드 실행시 q3 변수는 어떤 값이 될까? (상수) - 바뀌면 안됨.
const q3 = 1;
// q3 = q3 + 1; // Error
console.log(q3);
...
console.log(mixedArray); // [1, 'Damon', true, {…}, null]
...
// - 속성과 메서드로 구성.
// - 속성은 키(key)와 값(value)의 쌍으로 이루어져 있다. - 상태나 특징
// - 메서드는 함수(function)를 값으로 가진다. - 동작이나 행위
...
const me = {
  name: 'damon',
  job: 'developer',
  interests: 'game, popsong, webtoon'
}
...
// 형변환
// 성적 평균 구하는 프로그램 만들기.
// let mathScore = prompt('수학점수 입력'); // 80
// console.log(mathScore, typeof mathScore); // string // 주석 나중에
// let engScore = prompt('영어점수 입력'); // 50
// console.log(engScore, typeof engScore); // string

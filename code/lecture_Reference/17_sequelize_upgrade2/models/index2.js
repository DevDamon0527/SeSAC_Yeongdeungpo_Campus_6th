...
const TeamModel = require('./Team')(sequelize);
const GameModel = require('./Game')(sequelize);
const TeamGameModel = require('./TeamGame')(sequelize);

// 관계 형성
// foreign key 를 직접 넣지 않으면 모델명+기본키 값으로 자동 저장

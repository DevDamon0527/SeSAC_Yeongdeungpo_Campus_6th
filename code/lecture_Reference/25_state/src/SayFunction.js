...
const SayFunction = () => {
    console.log(useState("welcome!")); // 자료 잠시 저장 용도.
    ...
    const handleClick = () => {
        setMessage((currentMessage) => {
            return currentMessage === "welcome!" ? "안녕하세요" : "Hi";
        });
    };
    return (
        <div>
            {/* 
                ...
                - JS : addEventListener('click', onClickEvent) -> 괄호를 없애 함수를 바로 실행하지 않고, 클릭 발생 했을 때 함수가 호출되도록 함.

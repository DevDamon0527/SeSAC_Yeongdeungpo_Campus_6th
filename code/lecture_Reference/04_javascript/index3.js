...
let b2 = 77; // 변수 선언 & 할당
console.log(b2);
//let b2 = 78; // error: let 키워드 중복 선언 불가능   (참고) var도 해줄 것
b2 = 78; // 변수 값 재할당
console.log(b2); // 78
...
// 변수 x가 선언되기 전에 사용되었지만, JS 엔진은 선언을 최상단으로 올려서 undefined를 출력한 후, 나중에 변수를 초기화 하여 값을 할당
...
// 한번 정의되면 프로그램 실행 중에는 변경되지 않는 값을 말합니다. (고정된 값)

...
console.log((food(colaPrice))); // 2000  --> type이 뭘까요? --> number // 매개변수는 어떤 데이터 타입이든 상관없다.
...
// 호이스팅(hoisting) -> 함수, 변수
// - JS에서 변수 및 함수 선언이 해당 범위의 맨 위로 끌어올려지는 현상을 말한다.
// - "함수 선언문"이 호이스팅!
// - 변수에서는? - var

sayHello(); // 함수 "호출"을 "정의" 보다 먼저 했지요?
function sayHello() {
    console.log('hello~~!');
}
// -- 정상 출력.
...
// 코드의 가독성을 높이기 위해선 선언을 가능한 상단에 위치시키는것이 좋다!. 
